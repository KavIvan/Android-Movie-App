...
import com.kavajin_jelincic.popcornandchill.ViewModel.AppExecutors;
import com.kavajin_jelincic.popcornandchill.adapter.ReviewAdapter;
import com.kavajin_jelincic.popcornandchill.adapter.TrailerAdapter;
...
import com.kavajin_jelincic.popcornandchill.model.Review;
import com.kavajin_jelincic.popcornandchill.model.ReviewResult;
import com.kavajin_jelincic.popcornandchill.model.Trailer;
import com.kavajin_jelincic.popcornandchill.model.TrailerResponse;
    ...
    private void loadJSON(){
        try{
            if (BuildConfig.THE_MOVIE_DP_API_TOKEN.isEmpty()){
                ...
                Call<TrailerResponse> call = apiService.getMovieTrailer(movie_id, BuildConfig.THE_MOVIE_DP_API_TOKEN);
    ...
    private void loadReview(){
        try {
            if (BuildConfig.THE_MOVIE_DP_API_TOKEN.isEmpty()) {
                ...
                Client Client = new Client();
                Service apiService = Client.getClient().create(Service.class);
                Call<Review> call = apiService.getReview(movie_id, BuildConfig.THE_MOVIE_DP_API_TOKEN);
