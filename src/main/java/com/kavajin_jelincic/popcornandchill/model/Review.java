package com.kavajin_jelincic.popcornandchill.model;
...
public class Review implements Parcelable
{
    ...
    protected Review(Parcel in) {
        ...
        in.readList(this.results, (com.kavajin_jelincic.popcornandchill.model.ReviewResult.class.getClassLoader()));
